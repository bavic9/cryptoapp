            ...
            <div className=' h-[90px] m-auto px-6 border-b-2 border-gray-500 sticky top-0 left-0 z-10 bg-black'>
                <div className='lg:w-[70vw] m-auto flex justify-between items-center h-full p-4 text-orange'>
                    ...
                    <div className='btn-group'>
                        <button className='w-[100%] lg:px-[32px] md:px-[24px] px-4 lg:py-[14px] md:py-[10px] py-2 border border-orange bg-orange text-red-500 rounded-[24px_4px] font-semibold md:text-2xl text-lg hover:shadow-[rgb(0_0_0_/_15%)_0px_8px_24px]'>Connect Wallet</button>
                    </div>
