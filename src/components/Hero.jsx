        ...
        <div className='bg-black'>
            <div className='lg:max-w-[1240px] lg:grid grid-cols-[repeat(2,1fr)] justify-center items-center mx-auto lg:px-16 lg:py-36 space-y-8'>
                ...
                <div className='p-4 space-y-6 lg:px-0 px-8'>
                    <h1 className='text-white font-bold px-0 py-4 lg:text-[5.5rem] md:text-[4.5rem] text-[2.5rem] lg:leading-[1.2]'>Invest in Cryptocurreny with Your IRA</h1>
                    <p className='text-orange md:text-3xl text-xl font-semibold'>Buy & Sell Crypto 24/7</p>
                    <p className='text-white md:text-3xl text-xl font-semibold'>Buy, Sell, and store hundreds of cryptocurrencies</p>
