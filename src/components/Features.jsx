...
const Features = () => {
    ...
    if (!data) return <div className='featured lg:bg-bG lg:mt-[-5rem]'><div className=' h-[60vh] lg:w-[60%] m-auto pt-28 flex flex-col justify-center text-center pb-8 space-y-12'>
    ...
    return (
        <div className='featured w-full lg:bg-bG lg:mt-[-5rem] px-0 py-32 relative'>
            <div className='lg:max-w-[1240px] m-auto lg:grid grid-cols-[repeat(2,1fr)] justify-center items-center p-4 space-y-8 md:space-y-16'>
                ...
                <div className='flex flex-wrap lg:justify-evenly md:grid grid-cols-3 md:ml-[10%]'>
                    <div className='flex flex-col w-[170px] h-[170px] border shadow-[rgb(0_0_0_/_12%)_0px_8px_24px] text-center m-[0.4rem] px-[22px] py-3 rounded-3xl border-solid border-orange hover:shadow-[rgb(0_0_0_/_20%)_0px_8px_24px]'>
